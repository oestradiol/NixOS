...
| primary | Firefox enterprise policies | Mozilla enterprise policy documentation | daily Firefox policy model | `modules/security/browser.nix`, `PROJECT-STATE.md`, `docs/pipeline/TEST-PLAN.md` | active |
...
| strong-secondary | NixOS hardening synthesis | saylesss88 nix-book | NixOS-specific hardening/menu-of-options guidance and terminology | `docs/maps/SOURCE-COVERAGE.md`, `PROJECT-STATE.md` | active |
