...
| 10.1 Hostnames and usernames | adapted | `modules/core/users.nix`, docs | repo uses explicit `myOS.users` declarations with role-based naming (hardened vs daily); it does not treat generic usernames as a primary anonymity defense | https://madaidans-insecurities.github.io/guides/linux-hardening.html |
