...
| 17. Partitioning and mount options | baseline | `hosts/nixos/fs-layout.nix`, `scripts/rebuild-install.sh`, `docs/pipeline/PRE-INSTALL.md` | partitioning, LUKS, Btrfs subvolumes, tmpfs-root, and mount invariants are core repo design | https://madaidans-insecurities.github.io/guides/linux-hardening.html |
