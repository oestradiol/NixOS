...
| `modules/security/sandboxed-apps.nix` | 95-113 | `safeVrcxDaily`, `safeWindsurfDaily`, `safeVrcxDesktop`, `safeWindsurfDesktop` enabled in `systemPackages` | **A4 — resolved**: wrappers enabled 2026-04-16. Portal/file-chooser passthrough validated. |
