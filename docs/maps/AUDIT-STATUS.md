...
| staged self-owned WireGuard path | implemented | static review | `modules/security/wireguard.nix`, `modules/security/networking.nix`, `docs/pipeline/PRE-INSTALL.md`, `docs/pipeline/TEST-PLAN.md` | present in repo, off by default |
